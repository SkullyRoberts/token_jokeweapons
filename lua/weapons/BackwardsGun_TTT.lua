SWEP.PrintName = "BackwardsGun" -- The name of the weapon
    
SWEP.Author = "Token"
SWEP.Contact = "your email adress"--Optional
SWEP.Purpose = "Don't shoot where you're going, shoot where you've been."
SWEP.Instructions = "Shoot anyone following you quickly and efficiently"
...
SWEP.Primary.Damage = 35 --The amount of damage will the weapon do
...
bullet.Dir = self.Owner:GetAimVector()  * -1
...
function SWEP:SecondaryAttack()
	self.Owner:SetEyeAngles((self.Owner:GetAimVector() * -1):Angle())
end
